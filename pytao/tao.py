...
class Tao(_TaoAutogeneratedCommandMixin, TaoCore):
    ...
    def plot_ele_methods(
        ...
        **kwargs,
        ...
        by the method value.  Colors are consistent between runs; "Off" is
        black and "GARBAGE!" (indicating an issue with Bmad itself) is
        highlighted in red.

        Currently only supported by the matplotlib backend.
        ...
        columns : sequence of str, optional
            ...
            columns with data for the selected elements: `tracking_method`,
            `mat6_calc_method`, `spin_tracking_method`, `csr_method`,
            `space_charge_method`, `field_calc`, and `ptc_integration_type`.
    ...
    def unique_ele_ids_from_universe(
        self,
        ix_uni: str | int,
        *,
        no_slaves: bool = True,
        ...
        for ix_branch in self.inum(f"{ix_uni}^ix_branch"):
            ele_ids.extend(
                self.unique_ele_ids_from_branch(
                    ix_uni=ix_uni,
                    ix_branch=ix_branch,
                    no_slaves=no_slaves,
                    track_only=track_only,
    ...
    def unique_ele_ids_from_superuniverse(
        self,
        *,
        no_slaves: bool = True,
        track_only: bool = False,
        ...
        for ix_uni in self.inum("ix_universe"):
            ele_ids.extend(
                self.unique_ele_ids_from_universe(
                    ix_uni=ix_uni,
                    no_slaves=no_slaves,
                    track_only=track_only,
                )
